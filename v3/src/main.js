...
import { createInput } from "./input.js?v=3.7";
import { createTourLevel, STAGES } from "./level.js?v=3.7";
import { makeState, updateGame } from "./entities.js?v=3.7";
import { draw } from "./renderer.js?v=3.7";
