export const stage = {
  ...
  acts: [
    { name: "夜曲天台", start: 0, end: 3000, tint: "#121a38", mission: "踩准横移屋顶，避开追光。", music: "nocturne" },
    { name: "广告牌阵列", start: 3000, end: 6400, tint: "#1d1735", mission: "用滑翔接住竖移平台。", music: "nocturne" }
  ],
  ground: [
  ...
  pickups: [
    [690, 284, "glove"], [1610, 270, "feather"], [2600, 276, "cassette"],
    [3630, 294, "vinyl"], [4910, 268, "fever"], [5760, 284, "milk"]
  ],
  arcs: [
    [250, 346, 5, "note"], [1080, 344, 5, "note"], [2110, 346, 5, "note"],
    [3180, 362, 6, "note"], [4580, 264, 6, "note"], [5250, 348, 6, "note"]
  ],
  enemies: [
